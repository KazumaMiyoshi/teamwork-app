            ...
            <tbody>
              <?php foreach($records as $record):?>
                <tr>
                  ...
                  <td class="col-3">
                    <a href="./editForm.php?id=<?php echo h($record['id']); ?>" class="btn btn-outline-success ">編集</a>
                    <a href="./delete.php?id=<?php echo h($record['id']); ?>" class="btn btn-outline-danger">削除</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
